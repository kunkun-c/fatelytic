...
import { staticAnimations, getVariants, pathClassName, mergeRefs, type StaticAnimations } from './icon-utils';
...
const AnimateIcon = React.forwardRef<HTMLSpanElement, AnimateIconProps>((
  {
    asChild = false,
    animate = false,
